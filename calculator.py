...
class Application(Frame):
	...
	def createWidgets(self):
		...
		#Botones con funciones para convertir
		btn_hexa_bin = Button(calculator, text="Hexa-Binario", width=15, command= lambda:hexa_binario())
		btn_hexa_bin.grid(row=4, column=5)

		btn_hexa_binario = Button(calculator, text="Convertir a Binario", width=15, command= lambda:binarizar(decimal))
		btn_hexa_binario.grid(row=4, column=6)	

		btn_bin_deci = Button(calculator, text="Bin-Decimal", width=15, command= lambda:binario_a_decimal(x))
		btn_bin_deci.grid(row=5, column=5)	

		btn_octa_deci = Button(calculator, text="Octal-Decimal", width=15, command= lambda:octal_to_decimal(number))
		btn_octa_deci.grid(row=5, column=6)

		btn_octa_deci = Button(calculator, text="Hexa-Decimal", width=15, command= lambda:hexadecimal_a_decimal(d))
		btn_octa_deci.grid(row=6, column=5)
